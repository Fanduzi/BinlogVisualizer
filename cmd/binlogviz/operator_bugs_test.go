// Package binlogviz covers operator-facing analyze regressions: STATEMENT I/O, MIXED counting, and fixture product contracts.
// input: mock STATEMENT/MIXED parser events and real binlog fixtures through runAnalysis seams.
// output: exit-code and stdout/stderr contracts operators copy-paste: STATEMENT writes no report; MIXED still writes one.
