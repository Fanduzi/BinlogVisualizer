...
# Extract the last non-trivial binlog (contains our data)
# mysql-bin.000001 is just format desc (177 bytes)
# mysql-bin.000002 contains MySQL system init
# mysql-bin.000003 contains our INSERT/UPDATE/DELETE
echo "Extracting binlog with test data..."
docker cp $CONTAINER:/var/lib/mysql/mysql-bin.000003 ./minimal.binlog

echo "Binlog file size:"
ls -la ./minimal.binlog
...
echo ""
echo "To verify:"
echo "  go test ./cmd/binlogviz -v -run TestRealBinlog"
