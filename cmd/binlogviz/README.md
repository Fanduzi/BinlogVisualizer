...
| `*_test.go` | Covers flag parsing, SQL context mode validation, end-to-end analyze execution, streaming regression checks, fixture runs, benchmarks, temp-store cleanup behavior, and discovery-mode input resolution. |
