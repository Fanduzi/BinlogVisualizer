...
- Analyze keeps complete table data for JSON; `--top` / `--top-tables` limit only human report sections after totals are known, and explicit `--top-tables=0` is unlimited.
