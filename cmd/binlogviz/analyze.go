...
// output: rendered text/JSON/HTML analysis reports, stderr-only operator status, exit-2 no-data errors, and command-level creation and cleanup of temporary DuckDB stores.
