...
const htmlReportTemplate = htmlReportTemplateHead + SharedHTMLThemeCSS + htmlReportTemplateTail

const htmlReportTemplateHead = `<!DOCTYPE html>
<html lang="{{lang}}">
<head>
<meta charset="UTF-8">
