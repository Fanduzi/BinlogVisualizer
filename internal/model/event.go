...
// input: parsed binlog metadata, XA identity, and bounded SQL context captured from the binlog layer.
// output: NormalizedEvent values with stable transaction/operation semantics reused by analyzer and downstream report builders.
