...
const trendHTMLTemplate = trendHTMLTemplateHead + report.SharedHTMLThemeCSS + trendHTMLTemplateTail

const trendHTMLTemplateHead = `<!DOCTYPE html>
<html lang="{{lang}}">
<head>
<meta charset="UTF-8">
...
const trendHTMLTemplateTail = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  #trend-findings-list ol,
  #trend-recommendations-list ol {
    list-style: none;
    margin: 0;
    padding: 0;
    display: flex;
  ...
  #trend-findings-list li:hover {
    background: var(--surface-hover);
    border-color: rgba(var(--primary-rgb), 0.35);
    transform: translateX(2px);
  }
  #trend-findings-list li strong {
