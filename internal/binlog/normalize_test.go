...
// output: assertions for normalized provenance, XA identity, LOAD_DATA SQL, ADMIN not DDL, Unclassified QUERY emission, Ignored QUERY skip, partial-update as UPDATE, UTF-8-safe truncation, and skip behavior.
